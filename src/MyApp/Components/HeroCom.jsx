...
import ToDoList from "./ToDoListCom";
// import "./Style4.css";
    ...
    return (
        <>
            ...
            <section className="todo-main-section">
                <div className="container d-flex justify-content-center to-do-padd-def">

                    <div className="row to-do-width-def">
                            ...
                            <div className="center-div">
                                <div className="row d-flex justify-content-center">
                                    <div className="col-12 d-flex flex-column align-items-center">
                                        ...
                                        <br />
                                        <h2 className=" todo-main-heading">Inventory</h2>
                                        <br />
                                        ...
                                        <div className="d-flex justify-content-center align-items-center">
                                            ...
                                            {toggleBtn ?
                                                <button className="todo-u-btn" type="submit" title="add a item" onClick={listofItem}><i className="fa-solid fa-plus"></i></button> :
                                                <button className="todo-u-btn" type="submit" title="add a item" onClick={listofItem}><i className="fa-solid fa-pen-to-square"></i></button>
                                            }
                                        </div>
